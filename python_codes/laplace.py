# This code is obtained from https://github.com/wjmaddox/swa_gaussian with minor modifications. This GitHub repository is based on the paper: 'A Simple Baseline for Bayesian Uncertainty in Deep Learning' by Wesley Maddox, Timur Garipov, Pavel Izmailov, Dmitry Vetrov, and Andrew Gordon Wilson
...
class KFACLaplace(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        for mod in net.modules():
            ...
            if mod_class in ["Linear", "Conv2d", "ConstrainedLinear"]:
    ...
    def step(self, update_stats=True, update_params=True):
        ...
        for group in self.param_groups:
            ...
            if group["layer_type"] in ["Linear", "Conv2d", "ConstrainedLinear"]:
